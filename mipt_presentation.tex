...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{../Ultrasonic-LNS/error_vs_variance.png}
\end{figure}
\begin{itemize}
  \item Синий: аналитический метод
  \item Красный: метод Гаусса-Ньютона
  \item При 5 якорях итерационный метод точнее при большом шуме
\end{itemize}
